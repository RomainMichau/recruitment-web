...
public interface Library {
     ...
     * @throws BookIsNotAvailable    in case the wanted book is not available for borrow
     ...
     * @throws HasNotEnoughMoney in case the member has not enough money to pay for the book
     * @see Member#payBook(int)
     */
    void returnBook(Book book, Member member, LocalDate returnedAt) throws HasNotEnoughMoney, BookIsNotAvailable;
